    ...
    try {
      ...
      if (kpisResponse.ok) {
        ...
        if (kpisData.success) {
          ...
          // Sort by updatedAt descending to ensure Recent KPIs are actually recent
          userKpis.sort((a: any, b: any) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime())
          setKpis(userKpis)
