          ...
          <Card className={`border-2 ${
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-2 text-xs text-gray-600">
                {Math.abs(totalWeight - 100) <= 0.01 ? '✓ Perfect' : `Need ${Math.abs(100 - totalWeight).toFixed(1)}% ${totalWeight > 100 ? 'less' : 'more'}`}
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-2 text-xs text-gray-600">
                {validKpiCount < 3 ? `Need ${3 - validKpiCount} more KPI(s)` : 
                 validKpiCount > 5 ? `Remove ${validKpiCount - 5} KPI(s)` : '✓ Perfect (3-5)'}
              </div>
            </CardContent>
          </Card>
